...
class Habit extends DataClass implements Insertable<Habit> {
  ...
  @override
  int get hashCode => Object.hash(id, name, emoji, colorValue, createdAt);
  @override
...
class $CompletionsTable extends Completions
  ...
  @override
  List<GeneratedColumn> get $columns => [id, habitId, completedOn];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Completion extends DataClass implements Insertable<Completion> {
  ...
  Completion copyWith({int? id, int? habitId, DateTime? completedOn}) =>
      Completion(
        id: id ?? this.id,
